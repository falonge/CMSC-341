...
class HashTable {
    ...
    ******************************************/
    ...
    bool insertLinear(Person person, int index);
    bool insertQuadratic(Person person, int index);
    bool removeLinear(Person person, int index);
    bool removeQuadratic(Person person, int index);
    void rehashInsert();
    void rehashDelete();
};
#endif
