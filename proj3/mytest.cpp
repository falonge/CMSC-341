...
int main() {
  ...
  std::cout << std::endl << "Contents of queue1 after removing:\n";
  queue1.dump();
  ...
  cout << "\nTesting Copy Constructor: Making queue3 by copying queue1:\n";
  cout << "Contents of queue1:\n";
  queue1.dump();
  cout << "Contents of queue3:\n";
  queue3.dump();
  
  RQueue queue4(priorityFn1);
  queue4 = queue1;
    
  cout << "\nTesting Assignment Operator: Making queue4 by copying queue1:\n";
  cout << "Contents of queue1:\n";
  queue1.dump();
  cout << "Contents of queue4:\n";
  queue4.dump();
